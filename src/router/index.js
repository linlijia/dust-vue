...
const mainRoutes = {
  ...
  children: [
    ...
    // { path: '/analysis/current', component: _import('tongji/current'), name: 'analysisCurrent', meta: { title: '监测点实时数据统计', isTab: true } },
    // { path: '/analysis/device', component: _import('tongji/device'), name: 'analysisDevice', meta: { title: '城市设备异常统计', isTab: true } },
  ],
